...
<body class="bg-white dark:bg-gray-900">
    ...
    <main class="bg-white dark:bg-gray-900 ">
        <div class="w-full mt-10 px-10 mx-auto max-w-screen-sm text-gray-900 dark:text-gray-600">
            <?php
            ...
            if (isset($_GET['search'])) {
                ...
                // build the SQL query
                $sql = "SELECT stories.story_created_at, stories.story_title, stories.story_content, stories.story_image, users.name FROM stories INNER JOIN users ON stories.user_id = users.id WHERE stories.story_title LIKE '%$query%' OR stories.story_content LIKE '%$query%'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<img class='mx-auto rounded max-w-200 mb-4' src='" . $row['story_image'] . "'>";
